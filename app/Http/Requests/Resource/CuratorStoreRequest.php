...
class CuratorStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return  [
            ...
            '*.type' => ['required', 'string', Rule::in(['author','creator','discussion_commetee','first_supervisor','second_supervisor','third_supervisor','researcher','supervisor','co_researcher','contributer'
            ])],
