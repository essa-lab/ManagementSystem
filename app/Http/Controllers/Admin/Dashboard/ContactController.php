...
use App\Http\Requests\Dashboard\FooterRequest;
...
class ContactController extends Controller
{
    ...
    public function index()
    {
        ...
        $navigations = Contact::get();

        return ApiResponse::sendPaginatedResponse(NavigationResource::collection($navigations));    
    ...
    public function store(FooterRequest $request)
    {
        ...
        try{
        $navigation = Contact::create($data);
    ...
    public function update(FooterRequest $request, string $id)
    {
        ...
        try{
            ...
            $navigation = Contact::findOrFail($id);
