...
class LostResourceExport implements FromCollection , WithHeadings, WithMapping ,WithStyles
{
    ...
    */
    ...
    {
        $user = Auth::user();
        return ResourceCopy::where('status', 'lost')->whereBetween('updated_at', [$this->from, $this->to])
